...
class Soldier(pygame.sprite.Sprite):
	def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
		...
		for animation in animation_types:
			...
			num_of_frames = len(os.listdir(f'C:\\Users\\Akhil\\OneDrive\\Desktop\\Contra Files\\{self.char_type}\\{animation}'))
			for i in range(1,num_of_frames):
				img = pygame.image.load(f'C:\\Users\\Akhil\\OneDrive\\Desktop\\Contra Files\\{self.char_type}\\{animation}\\{i}.png').convert_alpha()
